...
internal
fun ProgramSource.fragment(
    identifier: IntRange,
    block: IntRange,
    firstAnnotationStart: Int? = null
) =
...
data class ProgramSourceFragment internal constructor(
    ...
    override fun equals(other: Any?): Boolean =
        other is ProgramSourceFragment && other.identifierString == identifierString && other.blockString == blockString
