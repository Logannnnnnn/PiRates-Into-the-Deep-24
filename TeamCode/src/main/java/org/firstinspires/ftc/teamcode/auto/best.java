...
@Autonomous(name = "best", group = "1")
public class best extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED, -26, 26, 26, -26, 1.0);
        ...
        sleep(200);
        encoderDrive(DRIVE_SPEED, -60, -60, -60, -60, 1.0);
        motorFrontLeft.setPower(0);
        motorBackLeft.setPower(0);
        motorFrontRight.setPower(0);
        motorBackRight.setPower(0);
        ...
        motorBackRight.setZeroPowerBehavior(BRAKE);
        sleep(200);
        encoderDrive(DRIVE_SPEED, 50, 50, 50, 50, 1.0);
        motorFrontLeft.setPower(0);
        motorBackLeft.setPower(0);
        motorFrontRight.setPower(0);
        motorBackRight.setPower(0);
