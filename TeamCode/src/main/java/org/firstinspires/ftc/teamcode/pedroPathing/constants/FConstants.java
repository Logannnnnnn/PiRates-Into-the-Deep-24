...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = 63.011;
        FollowerConstants.yMovement = 51.7459;

        FollowerConstants.forwardZeroPowerAcceleration = -60.1725;
        FollowerConstants.lateralZeroPowerAcceleration = -59.9491;

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.01, 0, 0.01, 0.01);
